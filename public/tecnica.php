...
<head>
    ...
    <title id="page-title">Técnica Culinária - FlavorWay</title>
...
<div class="tecnica-container">
    <a href="tecnicas.php" class="back-link">
        <i class="fas fa-arrow-left"></i> Voltar para Técnicas
    </a>
...
async function carregarTecnicaInfo() {
    try {
        ...
        console.error('Erro ao carregar informações da técnica:', error);
    }
}
            ...
            <div style="flex: 1;">
                ...
                <div class="tecnica-meta">
                    ...
                    <div class="meta-item">
                        ...
                        <span>${tecnica.tempo || 'Variável'}</span>
                    </div>
                </div>
            </div>
        </div>
...
async function carregarReceitasComTecnica() {
    try {
        // Primeiro, pega o nome da técnica
        ...
        if (tecData.success && tecData.tecnicas) {
            ...
            if (!tecnica) {
                mostrarMensagemVazia('Técnica não encontrada');
                return;
            }

            // Busca receitas que mencionam esta técnica
            ...
            if (data.success && data.receitas && data.receitas.length > 0) {
                // Filtra receitas que realmente usam esta técnica
                ...
                if (receitasFiltradas.length === 0) {
                    mostrarMensagemVazia('Nenhuma receita encontrada com esta técnica');
                    return;
                }
