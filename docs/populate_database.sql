...
-- RECEITAS - NORDESTE
-- ====================================
INSERT INTO `receitas` (`nome`, `descricao`, `tempo_preparo`, `pessoas`, `rating`, `dificuldade`, `regiao`, `regiao_id`, `destaque`, `badge`, `tempo_cozimento`, `rendimento`, `calorias`, `proteinas`, `carboidratos`, `gorduras`) VALUES
('Acarajé', 'Bolinho de feijão-fradinho frito no dendê, recheado com vatapá, caruru e camarão seco', '40 min', '4-6 porções', 4.8, 'Intermediário', 'Nordeste', 1, 1, 'Tradicional', '30 min', '12 unidades', '280 kcal', '12g', '25g', '15g'),
('Moqueca Baiana', 'Ensopado de peixe com leite de coco, dendê, tomate e pimentões', '30 min', '4-5 porções', 4.9, 'Intermediário', 'Nordeste', 1, 1, 'Premium', '40 min', '4 porções', '350 kcal', '28g', '12g', '22g'),
('Baião de Dois', 'Arroz com feijão de corda, queijo coalho, carne seca e temperos nordestinos', '25 min', '4 porções', 4.7, 'Básico', 'Nordeste', 1, 0, NULL, '35 min', '4 porções', '420 kcal', '18g', '52g', '16g'),
('Carne de Sol com Macaxeira', 'Carne de sol desfiada acompanhada de macaxeira cozida e manteiga de garrafa', '20 min', '3-4 porções', 4.6, 'Básico', 'Nordeste', 1, 0, NULL, '2 horas', '4 porções', '380 kcal', '32g', '28g', '18g'),
('Tapioca Recheada', 'Crepe de goma de tapioca com diversos recheios (coco, queijo, carne)', '10 min', '2 porções', 4.5, 'Básico', 'Nordeste', 1, 0, 'Rápido', '5 min', '2 unidades', '220 kcal', '8g', '35g', '6g');

-- ====================================
-- RECEITAS - SUDESTE
-- ====================================
INSERT INTO `receitas` (`nome`, `descricao`, `tempo_preparo`, `pessoas`, `rating`, `dificuldade`, `regiao`, `regiao_id`, `destaque`, `badge`, `tempo_cozimento`, `rendimento`, `calorias`, `proteinas`, `carboidratos`, `gorduras`) VALUES
('Feijoada Completa', 'Prato tradicional com feijão preto, carnes suínas e bovinas, acompanhado de arroz, couve e laranja', '45 min', '8-10 porções', 4.9, 'Intermediário', 'Sudeste', 2, 1, 'Tradicional', '3 horas', '10 porções', '520 kcal', '28g', '45g', '24g'),
('Pão de Queijo', 'Pãozinho de polvilho com queijo, crocante por fora e macio por dentro', '15 min', '20 unidades', 4.8, 'Básico', 'Sudeste', 2, 1, 'Popular', '25 min', '20 unidades', '85 kcal', '3g', '10g', '4g'),
('Virado à Paulista', 'Feijão refogado com bacon, linguiça, bisteca, couve e farofa de banana', '30 min', '4 porções', 4.7, 'Intermediário', 'Sudeste', 2, 0, NULL, '40 min', '4 porções', '680 kcal', '35g', '58g', '32g'),
('Tutu de Feijão', 'Feijão cozido e batido com farinha de mandioca, bacon e linguiça', '20 min', '6 porções', 4.6, 'Básico', 'Sudeste', 2, 0, NULL, '30 min', '6 porções', '320 kcal', '15g', '38g', '12g'),
('Frango com Quiabo', 'Frango ensopado com quiabo, tomate e temperos mineiros', '25 min', '4-5 porções', 4.5, 'Básico', 'Sudeste', 2, 0, NULL, '45 min', '5 porções', '290 kcal', '26g', '18g', '14g');

-- ====================================
-- RECEITAS - SUL
-- ====================================
INSERT INTO `receitas` (`nome`, `descricao`, `tempo_preparo`, `pessoas`, `rating`, `dificuldade`, `regiao`, `regiao_id`, `destaque`, `badge`, `tempo_cozimento`, `rendimento`, `calorias`, `proteinas`, `carboidratos`, `gorduras`) VALUES
('Churrasco Gaúcho', 'Carnes nobres assadas na grelha ou espeto, temperadas apenas com sal grosso', '30 min', '10-12 porções', 4.9, 'Intermediário', 'Sul', 3, 1, 'Premium', '1-2 horas', '12 porções', '450 kcal', '38g', '2g', '32g'),
('Barreado', 'Carne bovina cozida lentamente em panela de barro, servida com farinha de mandioca', '40 min', '6-8 porções', 4.7, 'Avançado', 'Sul', 3, 1, 'Tradicional', '12-24 horas', '8 porções', '480 kcal', '35g', '22g', '28g'),
('Arroz de Carreteiro', 'Arroz refogado com charque desfiado, tomate e temperos', '20 min', '4-5 porções', 4.6, 'Básico', 'Sul', 3, 0, NULL, '30 min', '5 porções', '380 kcal', '22g', '48g', '14g'),
('Polenta com Galinha Caipira', 'Polenta cremosa acompanhada de galinha caipira ensopada', '30 min', '6 porções', 4.5, 'Intermediário', 'Sul', 3, 0, NULL, '1 hora', '6 porções', '420 kcal', '28g', '42g', '18g'),
('Cuca Alemã', 'Bolo de origem alemã com farofa doce por cima', '25 min', '12 fatias', 4.8, 'Intermediário', 'Sul', 3, 0, 'Sobremesa', '40 min', '12 fatias', '320 kcal', '6g', '48g', '12g');

-- ====================================
-- RECEITAS - NORTE
-- ====================================
INSERT INTO `receitas` (`nome`, `descricao`, `tempo_preparo`, `pessoas`, `rating`, `dificuldade`, `regiao`, `regiao_id`, `destaque`, `badge`, `tempo_cozimento`, `rendimento`, `calorias`, `proteinas`, `carboidratos`, `gorduras`) VALUES
('Tacacá', 'Caldo quente de tucupi com goma de tapioca, jambu, camarão seco e pimenta', '30 min', '4-6 porções', 4.7, 'Intermediário', 'Norte', 4, 1, 'Tradicional', '20 min', '6 porções', '180 kcal', '12g', '22g', '6g'),
('Pato no Tucupi', 'Pato cozido em molho de tucupi, servido com arroz e jambu', '40 min', '6-8 porções', 4.8, 'Avançado', 'Norte', 4, 1, 'Premium', '2 horas', '8 porções', '520 kcal', '32g', '28g', '34g'),
('Pirarucu de Casaca', 'Peixe pirarucu em camadas com banana da terra, farinha d\'água e legumes', '35 min', '6 porções', 4.6, 'Intermediário', 'Norte', 4, 0, NULL, '45 min', '6 porções', '380 kcal', '28g', '35g', '16g'),
('Açaí na Tigela', 'Polpa de açaí batida servida com granola, banana e mel', '10 min', '2 porções', 4.9, 'Básico', 'Norte', 4, 0, 'Saudável', '5 min', '2 tigelas', '420 kcal', '8g', '68g', '14g'),
('Maniçoba', 'Folhas de mandioca cozidas por dias com carnes defumadas e temperos', '30 min', '8-10 porções', 4.5, 'Avançado', 'Norte', 4, 0, 'Tradicional', '7 dias', '10 porções', '450 kcal', '25g', '32g', '24g');

-- ====================================
-- RECEITAS - CENTRO-OESTE
-- ====================================
INSERT INTO `receitas` (`nome`, `descricao`, `tempo_preparo`, `pessoas`, `rating`, `dificuldade`, `regiao`, `regiao_id`, `destaque`, `badge`, `tempo_cozimento`, `rendimento`, `calorias`, `proteinas`, `carboidratos`, `gorduras`) VALUES
('Arroz com Pequi', 'Arroz cozido com fruto do pequi, frango e temperos do cerrado', '25 min', '6 porções', 4.7, 'Intermediário', 'Centro-Oeste', 5, 1, 'Tradicional', '35 min', '6 porções', '380 kcal', '18g', '52g', '14g'),
('Pacu Assado', 'Peixe pacu assado com ervas e limão, típico do pantanal', '20 min', '4 porções', 4.6, 'Básico', 'Centro-Oeste', 5, 0, NULL, '40 min', '4 porções', '280 kcal', '32g', '8g', '12g'),
('Empadão Goiano', 'Torta grande recheada com frango, guariroba, pequi e temperos', '40 min', '8-10 porções', 4.8, 'Avançado', 'Centro-Oeste', 5, 1, 'Festa', '1 hora', '10 porções', '420 kcal', '22g', '38g', '22g'),
('Maria Isabel', 'Arroz com charque e temperos, prato típico do Mato Grosso do Sul', '20 min', '4-5 porções', 4.5, 'Básico', 'Centro-Oeste', 5, 0, NULL, '30 min', '5 porções', '390 kcal', '24g', '46g', '16g'),
('Doce de Leite Caseiro', 'Doce cremoso feito com leite e açúcar, tradicional da região', '15 min', '15 porções', 4.8, 'Básico', 'Centro-Oeste', 5, 0, 'Sobremesa', '2 horas', '500g', '180 kcal', '4g', '28g', '6g');
